...
import BlurCircle from "../componets/BlurCircle.jsx";
...
const SeatLayout = () => {
    ...
    const bookTickets = async () => {
        try {
            ...
            if(!selectedTime || !selectedSeats.length) return toast.error('Please select a time a seats')
    ...
    return show ? (
        <div className="flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50">
            ...
            <div className="w-60 bg-primary/10 border border-primary/20 rounded-lg py-10 h-max md:sticky md:top-30">
                <p className="text-lg font-medium px-6">Available Timing</p>
