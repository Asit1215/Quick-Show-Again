    ...
    return nowPlayingMovies.length > 0 ? (
        <>
                    ...
                    {nowPlayingMovies.map((movie) => (
                        <div key={movie.id} onClick={() => setSelectedMovie(movie.id)} className={`relative max-w-40 cursor-pointer group-hover:not-hover:opacity-40 hover:translate-y-1 transition duration-300`}>
                            ...
                            {selectedMovie === movie.id && (
                                <div className="absolute top-2 ring-2 flex items-center justify-center bg-primary h-6 w-6 rounded">
            ...
            <div className="block text-sm font-medium mb-2">
                ...
                <div className="inline-flex items-center gap-2 border border-gray-600 px-3 py-3 rounded-md">
                ...
                <div className="mt-6">
                    ...
                    <ul className="space-y-3">
                        {Object.entries(dateTimeSelection).map(([date, times]) => (
                            <li key={date}>
                                <div className="flex flex-wrap gap-2 mt-1 text-sm">{date}</div>
